...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertFalse("Error: Location ID not inserted correctly", locationId==-1);
        ...
        assertTrue("Error: Row id is -1", weatherRowId!=-1);
        ...
        TestUtilities.validateCurrentRecord("Error: Could not validate data", c, weatherValues);

        assertFalse("Error: More than one row found", c.moveToNext());
    ...
    public long insertLocation() {
        ...
        assertTrue("Row ID is -1", locationRowId != -1);
